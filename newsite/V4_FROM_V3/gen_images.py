...
IMAGES_DEFS = { "home": "https://docs.google.com/spreadsheet/pub?key=0AuRz1oxD7nNEdFJXcU9NdTFhcFV5MlU2dnpTODdjX2c&output=csv", \
	#"whoweare":"https://docs.google.com/spreadsheet/pub?key=0AuRz1oxD7nNEdEstNlZoTlN0WXhwbnR6VHpoSGc1Vmc&output=csv", \
	 "whoweare":"https://docs.google.com/spreadsheet/pub?key=0AuRz1oxD7nNEdGlFcmota0dLQVJocVZ3WElqZnViSXc&output=csv", \
	#"sneakpeek":"https://docs.google.com/spreadsheet/pub?key=0AuRz1oxD7nNEdHdlNS0wOHJ2Q1NzTjRsTF9XU25zSEE&output=csv", \
	 "sneakpeek":"https://docs.google.com/spreadsheet/pub?key=0AuRz1oxD7nNEdDE2NnBxN181LXNRdW9SUy1zY25EUkE&output=csv", \
	#"clients":"https://docs.google.com/spreadsheet/pub?key=0AuRz1oxD7nNEdFRjOXdiRFJEazRadTh5ZFlIbk1CTVE&output=csv", \
	"clients":"https://docs.google.com/spreadsheet/pub?key=0AuRz1oxD7nNEdHBEYXRvVFZkZkpkeVhreFBDUnJNNkE&output=csv",\
	#"contacts":"https://docs.google.com/spreadsheet/pub?key=0AuRz1oxD7nNEdDN6d2xaYktMSlBCZnpqaXJGOEVnY0E&output=csv", \
	"contacts":"https://docs.google.com/spreadsheet/pub?key=0AuRz1oxD7nNEdEZoSW1kLXFqRWl5WUpSaU1mbGM0dXc&output=csv", \
...
def expand_item( accum_ids, asset_def, images_dct, onclick=None, init_vis=None, ahref=None, exturl=False, clickpanel_cb=None ):
	...
	# clickpanel_cb script...
	elif clickpanel_cb:
		content += common.emit_line( "<img id=\"%s\" src=\"%s\" onclick=\"%s\" onmouseover=\"%s\" onmouseout=\"%s\" alt=\"TheStudio\" >" % \
			(htmlid,image_path, clickpanel_cb, onmouseover, onmouseout) )
	else:
